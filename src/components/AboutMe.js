            ...
            <div className="row no-gutters">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">I have a 5 year expierience in digital media, and I own an art and design studio with my best friend as a partner. Actually, I'm a web development padawan.</p>
