            ...
            <div className="row no-gutters">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">Graphic and strategic designer, and Front End Developer by profession. Theatre producer and metal bands manager by coincidence. Studied both my degree and masters in la Ibero.</p> 
                  <p className="card-text">I have a 5 year expierience in digital media, and I own an art and design studio with my best friend as a partner.</p>
